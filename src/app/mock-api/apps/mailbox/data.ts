...
export const mails = [
    ...
    },
    {
        ...
        to         : 'me <hughes.brian@company.com>',
        date       : now.minus({ day: 1 }).set({ hour: 8, minute: 22 }).toISO(), // Yesterday - 08:22
    ...
    },
    {
        ...
        date       : now.minus({ day: 1 }).set({ hour: 16, minute: 43 }).toISO(),
    ...
    },
    {
        ...
        date       : now.minus({ day: 2 }).set({ hour: 11, minute: 28 }).toISO(),
    ...
    },
    {
        ...
        date       : now.minus({ day: 2 }).set({ hour: 7, minute: 12 }).toISO(),
    ...
    },
    {
        ...
        date       : now.minus({ day: 2 }).set({ hour: 6, minute: 1 }).toISO(),
    ...
    },
    {
        ...
        to         : 'me <hughes.brian@company.com>',
        date       : now.minus({ day: 5 }).set({ hour: 15, minute: 36 }).toISO(),
